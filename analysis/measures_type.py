...
measures.define_measure(
    name="oral_opioid", numerator=dataset.oral_opioid_any, denominator=denominator
)

measures.define_measure(
    name="trans_opioid", numerator=dataset.trans_opioid_any, denominator=denominator
)

measures.define_measure(
    name="par_opioid", numerator=dataset.par_opioid_any, denominator=denominator
)

measures.define_measure(
    name="oth_opioid", numerator=dataset.oth_opioid_any, denominator=denominator
)
